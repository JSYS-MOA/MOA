    ...
    return (
        ...
        >
            <div className="tax-Print">
                <div className="tax-PrintDate">{date}</div>
                <table className="tax-Table" style={{marginTop:"12px"}}>
                    <colgroup>
                ...
                <table className="tax-Table">
                    ...
                    <tr>
                        ...
                        <td className="tax-Label" colSpan={4}>수정사유</td>
                    </tr>
                    <tr>
                        <td className="tax-Label">년</td>
                        <td className="tax-Label">월</td>
                        <td className="tax-Label">일</td>
                        {['십','억','천','백','십','만','천','백','십','일'].map((n, i) => (
                            <td key={i} className="tax-Label">{n}</td>
                        ))}
                        {['십','억','천','백','십','만','천','백','십','일'].map((n, i) => (
                            <td key={i+10} className="tax-Label">{n}</td>
                        ))}
                        <td className="tax-Label" colSpan={4}></td>
                    </tr>
                    <tr>
                        ...
                        <td className="tax-Value" colSpan={4}></td>
                    </tr>
                    <tr>
                ...
                <table className="tax-Table">
                    ...
                    <tr>
                        ...
                        <td className="tax-Value"></td>
                        <td className="tax-Value"></td>
                        <td className="tax-Value tax-Right"></td>
                        <td className="tax-Value"></td>
                    </tr>
                    </tbody>
                </table>
